                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pl-1.5">
                  <div className="flex flex-col">
                    <textarea
                      ...
                      className="w-full text-xs p-1.5 bg-white border border-slate-200 rounded-lg resize-none focus:outline-none focus:ring-1 focus:ring-[#159BAD] text-slate-700"
                      value={pair.question}
